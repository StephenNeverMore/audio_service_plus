 ...
 * AudioservicePlugin
 */
public class AudioServicePlusPlugin implements FlutterPlugin, ActivityAware {
...
//    }
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        ...
        if (audioHandlerInterface == null) {
            ...
            audioHandlerInterface = new AudioHandlerInterface(
    ...
    public void onDetachedFromEngine(FlutterPluginBinding binding) {
        ...
        if (audioHandlerInterface != null && audioHandlerInterface.messenger == flutterPluginBinding.getBinaryMessenger()) {
    ...
    private void connect() {
        if (mediaBrowser == null) {
            mediaBrowser = new MediaBrowserCompat(applicationContext,
                    new ComponentName(applicationContext, AudioService.class), connectionCallback,
                    null);
    ...
    private void sendNotificationClicked() {
        ...
        if (activity.getIntent().getAction() != null) {
            boolean clicked = activity.getIntent().getAction().equals(
                    AudioService.NOTIFICATION_CLICK_ACTION);
...
//        };
            ...
            try {
                if (wrongEngineDetected) {
                    throw new IllegalStateException(
                            "The Activity class declared in your AndroidManifest.xml is wrong or has not provided the correct FlutterEngine. Please see the README for instructions.");
                }
                switch (call.method) {
                    case "configure":
                        ...
                        AudioServiceConfig config = new AudioServiceConfig(
                                context.getApplicationContext());
                        config.androidNotificationClickStartsActivity = (Boolean) configMap.get(
                                "androidNotificationClickStartsActivity");
                        config.androidNotificationOngoing = (Boolean) configMap.get(
                                "androidNotificationOngoing");
                        config.androidResumeOnClick = (Boolean) configMap.get(
                                "androidResumeOnClick");
                        config.androidNotificationChannelId = (String) configMap.get(
                                "androidNotificationChannelId");
                        config.androidNotificationChannelName = (String) configMap.get(
                                "androidNotificationChannelName");
                        config.androidNotificationChannelDescription = (String) configMap.get(
                                "androidNotificationChannelDescription");
                        config.notificationColor = configMap.get(
                                "notificationColor") == null ? -1 : getInt(
                                configMap.get("notificationColor"));
                        config.androidNotificationIcon = (String) configMap.get(
                                "androidNotificationIcon");
                        config.androidShowNotificationBadge = (Boolean) configMap.get(
                                "androidShowNotificationBadge");
                        config.androidStopForegroundOnPause = (Boolean) configMap.get(
                                "androidStopForegroundOnPause");
                        config.artDownscaleWidth = configMap.get(
                                "artDownscaleWidth") != null ? (Integer) configMap.get(
                                "artDownscaleWidth") : -1;
                        config.artDownscaleHeight = configMap.get(
                                "artDownscaleHeight") != null ? (Integer) configMap.get(
                                "artDownscaleHeight") : -1;
                        config.setBrowsableRootExtras(
                                (Map<?, ?>) configMap.get("androidBrowsableRootExtras"));
                        if (activity != null) {
    ...
    private static class AudioHandlerInterface implements MethodCallHandler,
            ...
            if (audioHandlerInterface != null) {
                ...
                audioHandlerInterface.invokeMethod("getChildren", args, new MethodChannel.Result() {
                    ...
                    public void success(Object obj) {
                        ...
                        @SuppressWarnings("unchecked") List<Map<?, ?>> rawMediaItems = (List<Map<?, ?>>) response.get(
                                "children");
        ...
        public void onLoadItem(String itemId,
                               final MediaBrowserServiceCompat.Result<MediaBrowserCompat.MediaItem> result) {
            if (audioHandlerInterface != null) {
                Map<String, Object> args = new HashMap<>();
                args.put("mediaId", itemId);

                audioHandlerInterface.invokeMethod("getMediaItem", args,
                        new MethodChannel.Result() {
                            ...
                            public void success(Object obj) {
                                ...
                                if (rawMediaItem != null) {
                                    MediaBrowserCompat.MediaItem mediaItem = rawToMediaItem(
                                            rawMediaItem);
        ...
        public void onPrepareFromMediaId(String mediaId, Bundle extras) {
            invokeMethod("prepareFromMediaId",
                    mapOf("mediaId", mediaId, "extras", bundleToMap(extras)));
        }

        @Override
        public void onPrepareFromSearch(String query, Bundle extras) {
            invokeMethod("prepareFromSearch", mapOf("query", query, "extras", bundleToMap(extras)));
        }

        @Override
        public void onPrepareFromUri(Uri uri, Bundle extras) {
            invokeMethod("prepareFromUri",
                    mapOf("uri", uri.toString(), "extras", bundleToMap(extras)));
        }
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            invokeMethod("playFromMediaId",
                    mapOf("mediaId", mediaId, "extras", bundleToMap(extras)));
        }

        @Override
        public void onPlayFromSearch(String query, Bundle extras) {
            invokeMethod("playFromSearch", mapOf("query", query, "extras", bundleToMap(extras)));
        }

        @Override
        public void onPlayFromUri(Uri uri, Bundle extras) {
            invokeMethod("playFromUri",
                    mapOf("uri", uri.toString(), "extras", bundleToMap(extras)));
        }
        ...
        public void onAddQueueItemAt(MediaMetadataCompat metadata, int index) {
            invokeMethod("insertQueueItem",
                    mapOf("mediaItem", mediaMetadata2raw(metadata), "index", index));
        }
        ...
        public void onCustomAction(String action, Bundle extras) {
            invokeMethod("customAction", mapOf("name", action, "extras", bundleToMap(extras)));
        }

        @Override
        public void onSetRating(RatingCompat rating) {
            invokeMethod("setRating", mapOf("rating", rating2raw(rating), "extras", null));
        }

        @Override
        public void onSetRating(RatingCompat rating, Bundle extras) {
            invokeMethod("setRating",
                    mapOf("rating", rating2raw(rating), "extras", bundleToMap(extras)));
        }
        ...
        public void onMethodCall(MethodCall call, Result result) {
            ...
            switch (call.method) {
                case "setMediaItem": {
                    Executors.newSingleThreadExecutor().execute(() -> {
                        try {
                            ...
                            handler.post(() -> {
                                result.error("UNEXPECTED_ERROR", "Unexpected error",
                ...
                case "setQueue": {
                    Executors.newSingleThreadExecutor().execute(() -> {
                        try {
                            @SuppressWarnings("unchecked") List<Map<?, ?>> rawQueue = (List<Map<?, ?>>) args.get(
                                    "queue");
                ...
                case "setState": {
                    ...
                    long updateTimeSinceEpoch = stateMap.get(
                            "updateTime") == null ? System.currentTimeMillis() : getLong(
                            stateMap.get("updateTime"));
                    ...
                    AudioService.instance.setState(actions, actionBits, compactActionIndices,
                            processingState, playing, position, bufferedPosition, speed,
                            updateTimeSinceBoot, errorCode, errorMessage, repeatMode, shuffleMode,
                            captioningEnabled, queueIndex);
                    result.success(null);
                    break;
                }
                case "setAndroidPlaybackInfo": {
                    ...
                    final Integer volumeControlType = (Integer) playbackInfo.get(
                            "volumeControlType");
                    final Integer maxVolume = (Integer) playbackInfo.get("maxVolume");
                    final Integer volume = (Integer) playbackInfo.get("volume");
                    AudioService.instance.setPlaybackInfo(playbackType, volumeControlType,
                            maxVolume, volume);
                    break;
                }
                ...
                case "androidForceEnableMediaButtons": {
                    ...
                    if (silenceAudioTrack == null) {
                        ...
                        @SuppressWarnings("deprecation") final AudioTrack audioTrack = new AudioTrack(
                                AudioManager.STREAM_MUSIC, SILENCE_SAMPLE_RATE,
                                AudioFormat.CHANNEL_CONFIGURATION_MONO,
                                AudioFormat.ENCODING_PCM_8BIT, silence.length,
        ...
        private void destroy() {
            if (silenceAudioTrack != null) silenceAudioTrack.release();
        }
    }
    ...
    private static List<Map<?, ?>> mediaItems2raw(List<MediaBrowserCompat.MediaItem> mediaItems) {
        ...
        for (MediaBrowserCompat.MediaItem mediaItem : mediaItems) {
            ...
            MediaMetadataCompat mediaMetadata = AudioService.getMediaMetadata(
    ...
    private static Map<?, ?> mediaMetadata2raw(MediaMetadataCompat mediaMetadata) {
        ...
        raw.put("displayTitle",
                metadataToString(mediaMetadata, MediaMetadataCompat.METADATA_KEY_DISPLAY_TITLE));
        raw.put("displaySubtitle",
                metadataToString(mediaMetadata, MediaMetadataCompat.METADATA_KEY_DISPLAY_SUBTITLE));
        raw.put("displayDescription", metadataToString(mediaMetadata,
     ...
     */
    private static MediaDescriptionCompat addExtrasToMediaDescription(
            MediaDescriptionCompat description, Map<?, ?> extras) {
        ...
        return new MediaDescriptionCompat.Builder().setTitle(description.getTitle()).setSubtitle(
                description.getSubtitle()).setDescription(
                description.getDescription()).setIconBitmap(description.getIconBitmap()).setIconUri(
                description.getIconUri()).setMediaId(description.getMediaId()).setMediaUri(
                description.getMediaUri()).setExtras(extrasBundle).build();
    }

    private static MediaBrowserCompat.MediaItem rawToMediaItem(Map<?, ?> rawMediaItem) {
        MediaMetadataCompat mediaMetadata = createMediaMetadata(rawMediaItem);
        final MediaDescriptionCompat description = addExtrasToMediaDescription(
                mediaMetadata.getDescription(), (Map<?, ?>) rawMediaItem.get("extras"));
    ...
    private static List<MediaSessionCompat.QueueItem> raw2queue(List<Map<?, ?>> rawQueue) {
        ...
        for (Map<?, ?> rawMediaItem : rawQueue) {
            MediaMetadataCompat mediaMetadata = createMediaMetadata(rawMediaItem);
            MediaDescriptionCompat description = addExtrasToMediaDescription(
                    mediaMetadata.getDescription(), (Map<?, ?>) rawMediaItem.get("extras"));
    ...
    public static Integer getInt(Object o) {
        return (o == null || o instanceof Integer) ? (Integer) o : Integer.valueOf(
                (int) ((Long) o).longValue());
    }
    ...
    static Map<String, Object> bundleToMap(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            ...
            @SuppressWarnings("deprecation") Object value = bundle.getSerializable(key);
            if (value != null) {
                map.put(key, value);
            }
        }
