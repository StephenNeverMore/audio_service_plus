...
abstract class BackgroundAudioTask {
  ...
  /// Deprecated. Use [AudioServiceConfig.fastForwardInterval] from [AudioServicePlus.config] instead.
  @Deprecated(
      "Use [AudioServiceConfig.fastForwardInterval] from [AudioService.config] instead.")
  Duration get fastForwardInterval =>
      AudioServicePlus.config.fastForwardInterval;

  /// Deprecated. Use [AudioServiceConfig.rewindInterval] from [AudioServicePlus.config] instead.
  @Deprecated(
      "Use [AudioServiceConfig.rewindInterval] from [AudioService.config] instead.")
  Duration get rewindInterval => AudioServicePlus.config.rewindInterval;
...
mixin SeekHandler on BaseAudioHandler {
  ...
  @override
  Future<void> fastForward() =>
      _seekRelative(AudioServicePlus.config.fastForwardInterval);

  @override
  Future<void> rewind() =>
      _seekRelative(-AudioServicePlus.config.rewindInterval);
...
/// The configuration options to use when intializing the [AudioServicePlus].
...
class AudioServiceBackground {
  static SwitchAudioHandler get _handler =>
      AudioServicePlus._handler as SwitchAudioHandler;
  ...
  /// Deprecated. Use [AudioServicePlus.init] instead.
  @Deprecated("Use AudioService.init instead")
  ...
  static Future<void> notifyChildrenChanged(
      [String parentMediaId = AudioServicePlus.browsableRootId]) async {
    await _platform.notifyChildrenChanged(
        NotifyChildrenChangedRequest(parentMediaId: parentMediaId));
  }

  /// Deprecated. Use [AudioServicePlus.androidForceEnableMediaButtons] instead.
  @Deprecated("Use AudioService.androidForceEnableMediaButtons instead.")
  static Future<void> androidForceEnableMediaButtons() async {
    await AudioServicePlus.androidForceEnableMediaButtons();
  }
...
class _HandlerCallbacks extends AudioHandlerCallbacks {
  ...
  Future<void> onNotificationClicked(
    ...
    AudioServicePlus._notificationClicked.add(request.clicked);
  }
