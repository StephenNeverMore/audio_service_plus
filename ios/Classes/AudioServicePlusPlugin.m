#import "AudioServicePlusPlugin.h"
...
static NSHashTable<AudioServicePlusPlugin *> *plugins = nil;
...
@implementation AudioServicePlusPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    @synchronized(self) {
        ...
        AudioServicePlusPlugin *instance = [[AudioServicePlusPlugin alloc] initWithRegistrar:registrar];
...
- (void)invokeClientMethod:(NSString *)method arguments:(id _Nullable)arguments {
    for (AudioServicePlusPlugin *plugin in plugins) {
